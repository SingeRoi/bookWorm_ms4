...
class OrderCoin(models.Model):
    order_number = models.CharField(max_length=32, null=False, editable=False)
    user_profile = models.ForeignKey(UserProfile, on_delete=models.SET_NULL,
                                     null=True, blank=True, related_name='coin_orders')
...
class OrderChapter(models.Model):
    order_number = models.CharField(max_length=32, null=False, editable=False)
    user_profile = models.ForeignKey(UserProfile, on_delete=models.SET_NULL,
                                     null=True, blank=True, related_name='chapter_orders')
...
class OrderChapterLineItem(models.Model):
     ...
     def save(self, *args, **kwargs):
        ...
        """
        self.lineitem_total = self.chapter.price
        self.chapter_no = self.chapter.chapter
